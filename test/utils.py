...
def trigger_update(account_id):
    ...
    state_machine_arns = [
        ...
        f'arn:{partition}:states:{region}:{account_id}:stateMachine:{PREFIX}inventory-RedshiftClusters-StateMachine',
        f'arn:{partition}:states:{region}:{account_id}:stateMachine:{PREFIX}inventory-RedshiftServerlessNamespaces-StateMachine',
        f'arn:{partition}:states:{region}:{account_id}:stateMachine:{PREFIX}inventory-RedshiftServerlessWorkgroups-StateMachine',
